  ...
  return (
    <InformTemplate>
      <div className="card-title">
        <h1 className="text-center">{`Informe: ${informe.seccion}`}</h1>
        <pre className="my-3" style={{ marginLeft: "60%" }}>
          {`*El Informe muestra la información adquirida por
las secciones por medio de la plataforma somosrc.net.`}
        </pre>
      </div>
      <Container>
